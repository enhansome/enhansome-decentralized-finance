...
* [Optimism](https://optimism.io) ([source code](https://github.com/ethereum-optimism/optimism) ⭐ 6,473 | 🐛 840 | 🌐 Go | 📅 2026-09-20, [docs](https://docs.optimism.io/)) - $843M TVL, created OP Stack used by Base and others (Superchain)
...
* [zkSync Era](https://zksync.io) ([source code](https://github.com/matter-labs/zksync-era) ⭐ 3,235 | 🐛 147 | 🌐 Rust | 📅 2026-09-17, [docs](https://docs.zksync.io/)) - Native account abstraction, low fees
...
* [Rabby](https://rabby.io) ([source code](https://github.com/RabbyHub/Rabby) ⭐ 1,894 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-18) - Desktop wallet with better multi-chain UX
...
If you are interested in AI search, check out this [awesome generative engine optimization list](https://github.com/amplifying-ai/awesome-generative-engine-optimization) ⭐ 512 | 🐛 124 | 📅 2026-04-14.
