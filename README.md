...
* [LUSD](https://www.liquity.org) ([source code](https://github.com/liquity/dev) ⭐ 360 | 🐛 57 | 🌐 JavaScript | 📅 2025-11-26, [docs](https://docs.liquity.org/)) - 0% interest, ETH-only collateral, immutable protocol
...
* [EigenLayer](https://eigenlayer.xyz) ([source code](https://github.com/Layr-Labs/eigenlayer-contracts) ⭐ 719 | 🐛 42 | 🌐 Solidity | 📅 2026-09-24, [docs](https://docs.eigenlayer.xyz/)) - $14.3B+ TVL, pioneered restaking concept. Secures "Actively Validated Services" (AVSs)
...
* [Optimism](https://optimism.io) ([source code](https://github.com/ethereum-optimism/optimism) ⭐ 6,472 | 🐛 825 | 🌐 Go | 📅 2026-09-25, [docs](https://docs.optimism.io/)) - $843M TVL, created OP Stack used by Base and others (Superchain)
...
* [zkSync Era](https://zksync.io) ([source code](https://github.com/matter-labs/zksync-era) ⭐ 3,236 | 🐛 148 | 🌐 Rust | 📅 2026-09-24, [docs](https://docs.zksync.io/)) - Native account abstraction, low fees
...
* [Rabby](https://rabby.io) ([source code](https://github.com/RabbyHub/Rabby) ⭐ 1,898 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-24) - Desktop wallet with better multi-chain UX
...
If you are interested in AI search, check out this [awesome generative engine optimization list](https://github.com/amplifying-ai/awesome-generative-engine-optimization) ⭐ 514 | 🐛 130 | 📅 2026-04-14.
