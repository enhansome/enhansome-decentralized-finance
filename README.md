...
* [Optimism](https://optimism.io) ([source code](https://github.com/ethereum-optimism/optimism) ⭐ 6,464 | 🐛 855 | 🌐 Go | 📅 2026-08-24, [docs](https://docs.optimism.io/)) - $843M TVL, created OP Stack used by Base and others (Superchain)
...
* [zkSync Era](https://zksync.io) ([source code](https://github.com/matter-labs/zksync-era) ⭐ 3,232 | 🐛 148 | 🌐 Rust | 📅 2026-08-24, [docs](https://docs.zksync.io/)) - Native account abstraction, low fees
...
* [Rabby](https://rabby.io) ([source code](https://github.com/RabbyHub/Rabby) ⭐ 1,884 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-25) - Desktop wallet with better multi-chain UX
...
If you are interested in AI search, check out this [awesome generative engine optimization list](https://github.com/amplifying-ai/awesome-generative-engine-optimization) ⭐ 490 | 🐛 103 | 📅 2026-04-14.
