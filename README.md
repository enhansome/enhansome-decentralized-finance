# Awesome Decentralized Finance with stars
...
* [USD Coin (USDC)](https://www.circle.com/en/usdc) ([source code](https://github.com/circlefin/stablecoin-evm) ⭐ 795 | 🐛 127 | 🌐 TypeScript | 📅 2026-08-12, [docs](https://developers.circle.com/stablecoins/docs)) - $59B+ market cap, issued by Circle
...
* [LUSD](https://www.liquity.org) ([source code](https://github.com/liquity/dev) ⭐ 358 | 🐛 57 | 🌐 JavaScript | 📅 2025-11-26, [docs](https://docs.liquity.org/)) - 0% interest, ETH-only collateral, immutable protocol
* [GHO](https://gho.aave.com) ([source code](https://github.com/aave/gho-core) ⚠️ Archived, [docs](https://docs.gho.xyz/)) - Minted by borrowing on Aave
...
* [tBTC](https://threshold.network/earn/btc) ([source code](https://github.com/keep-network/tbtc-v2) ⭐ 91 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-03) - Decentralized Bitcoin bridge
...
* [EigenLayer](https://eigenlayer.xyz) ([source code](https://github.com/Layr-Labs/eigenlayer-contracts) ⭐ 718 | 🐛 44 | 🌐 Solidity | 📅 2026-08-30, [docs](https://docs.eigenlayer.xyz/)) - $14.3B+ TVL, pioneered restaking concept. Secures "Actively Validated Services" (AVSs)
...
* [Augur](https://augur.net) ([source code](https://github.com/AugurProject/augur) ⭐ 506 | 🐛 178 | 🌐 TypeScript | 📅 2023-07-23, [docs](https://docs.augur.net/)) - OG prediction market protocol
...
* [Optimism](https://optimism.io) ([source code](https://github.com/ethereum-optimism/optimism) ⭐ 6,469 | 🐛 857 | 🌐 Go | 📅 2026-09-03, [docs](https://docs.optimism.io/)) - $843M TVL, created OP Stack used by Base and others (Superchain)
...
* [zkSync Era](https://zksync.io) ([source code](https://github.com/matter-labs/zksync-era) ⭐ 3,232 | 🐛 147 | 🌐 Rust | 📅 2026-09-01, [docs](https://docs.zksync.io/)) - Native account abstraction, low fees
...
* [Rabby](https://rabby.io) ([source code](https://github.com/RabbyHub/Rabby) ⭐ 1,890 | 🐛 158 | 🌐 TypeScript | 📅 2026-09-03) - Desktop wallet with better multi-chain UX
...
If you are interested in AI search, check out this [awesome generative engine optimization list](https://github.com/amplifying-ai/awesome-generative-engine-optimization) ⭐ 497 | 🐛 112 | 📅 2026-04-14.
